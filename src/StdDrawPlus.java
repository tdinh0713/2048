...
//        frame.setJMenuBar(createMenuBar());
    ...
    *************************************************************************/
    ...
    /**
     * Method adapted by Thong Dinh to use for his 2048 clone.
    ...
    public static void text(double x, double y, String s) {
        offscreen.setFont(new Font("SansSerif", Font.PLAIN, 72));
        setPenColor(WHITE);
        offscreen.drawString(s, (float) (47), (float) (245));
        draw();
    }
    ...
    *************************************************************************/
    ...
    /**
     * Methods added by Thong Dinh to use for his 2048 clone.
     * @return
     */
